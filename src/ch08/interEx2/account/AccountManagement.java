...
class AccountManagement {
    ...
    public AccountManagement(int maxSize) {
       //accountList = new Account(Account타입으로 필드에 선언했으니까)      , ex: int[] a = new int[6]; <-이건 int타입으로 선언했으니까 new int
        accountList = new Account[maxSize];  // 계좌 목록 배열을 maxsize만큼 생성한다
    ...
    public void addAccount(String accountNumber, double balance) {
        ...
        accountList[numAccounts] = ac;       //배열의 순서대로 넣어야하기때문에 증가하는 애가 필요해서 numAccount++
        System.out.println("입력하신 계좌번호는: " + accountList[numAccounts].getAccountNumber() + "입니다");
        numAccounts++;
    }
    ...
    public void showAccountList() {
        ...
        // ...
        // ------------------------------------
                        //리스트 = accountNumber, balance 들어가 있을 거고
